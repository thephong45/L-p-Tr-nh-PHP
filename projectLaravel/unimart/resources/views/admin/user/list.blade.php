            ...
            <div class="card-body">
                ...
                <form action="{{url('admin/user/action')}}" method="POST">
                    ...
                    <table class="table table-striped table-checkall">
                            ...
                            @foreach($users as $user)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(Auth::id()!=$user->id)
                                            <a href="{{route('delete_user', $user->id)}}" onclick="return confirm('Ban co chac la xoa không?')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                        @endif
                        ...
                        @else
                            <tr>
                                <td colspan="7" class="bg-white">Không tìm thấy bản ghi thỏa mãng</td>
                            </tr>
                        @endif
