...
//        return redirect()->route('post.show');
        ...
        //Chuyển hướng kèm theo session, tham số đầu là tên session, tham số thứ 2 là thông báo
...
//        $posts = Post::all();
        ...
        //= ========= Phần 18 : Phân trang ==================
        //============ Cách query builder ====================
        //Tạo hiển thị phân trang, 3 là bảng ghi hiển thị trên 1 trang
//        $posts = DB::table('posts')->paginate(3);
        //Tạo và hiển thị thanh phân trang chỉ có  next, prev
//        $posts = DB::table('posts')->simplePaginate(2);
        //Phân trang có điều kiện
        //Phân trang có tham số (Bên file post/index)
        //Tùy chỉnh đường dẫn thanh phân trang
        ...
        //=================== Cách ORM =====================
        //Tạo hiển thị phân trang
        $posts = Post::paginate(2);
        //Tạo và hiển thị thanh phân trang chỉ có  next, prev
//        $posts = Post::simplePaginate(2);
        //Phân trang có điều kiện, id > 24 và sắp xếp theo id, giảm dần
//        $posts = Post::where('id','>',24)->orderby('id', 'desc')->paginate(2);
        //Phân trang có tham số(Bên file post/index)
        //Tùy chỉnh đường dẫn thanh phân trang
//        $posts = Post::paginate(2)->withPath('demo/show');
...
//        return $post;
    ...
    //Chuyển đến trang ngoài hệ thống
    public function outSystem(){
        return redirect()->away('https://getbootstrap.com/');
    }
